...
const submit = document.querySelector('#formNewFilm [type = "submit"]');
const input = document.querySelector('#formNewFilm input');
...
submit.addEventListener("click", event => {
    ...
    if (newFilm) {
        personalMovieDB.movies.push(newFilm.toLowerCase());
    } 
